  ...
  const boxData = [
    {
      image: (
        <svg
          ...
          class='lucide lucide-zap h-12 w-12 text-yellow-400 mx-auto mb-4'
        >
    ...
    },
    {
      image: (
        <svg
          ...
          stroke-linecap='round'
          stroke-linejoin='round'
          class='lucide lucide-shield h-12 w-12 text-green-400 mx-auto mb-4'
        >
    ...
    },
    {
      image: (
        <svg
          ...
          stroke-linecap='round'
          stroke-linejoin='round'
          class='lucide lucide-globe h-12 w-12 text-blue-400 mx-auto mb-4'
        >
